...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Gestion Transparente</a>
        </div>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>GOBIERNO Y TRANSPARENCIA <small>Haciendo m&aacute;s claro el futuro</small></h1>
                <ol class="breadcrumb">
                    <li class="active">
                        <!--<i class="fa fa-dashboard"></i>-->
                        Porque los gobiernos democráticos deben a través de la tecnología, brindar a sus ciudadanos la información necesaria
                        para ser transparentes. Para que el ciudadano común, impulse el esfuerzo de su país adelante.
                    </li>
                </ol>

                <!--Imagen de gobierno abierto-->
